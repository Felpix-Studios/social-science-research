...
2. Create `quality_reports/specs/YYYY-MM-DD_description.md` using `${CLAUDE_PLUGIN_ROOT}/skills/new-project/assets/requirements-spec.md` (read via `cat "${CLAUDE_PLUGIN_ROOT}/skills/new-project/assets/requirements-spec.md"`; the template ships with the plugin and is not copied into the project)
...
**Template:** `${CLAUDE_PLUGIN_ROOT}/skills/new-project/assets/requirements-spec.md`
