---
name: new-project
description: "Start a new research project. Structured interview formalizes the idea; generates research questions with identification strategies and a project spec. Use when developing or documenting a new research idea, not searching literature or data."
when_to_use: "new project, start research, I have an idea, help develop this, I want to study X, formalize this idea, what's my research question, what identification strategy, write up project idea, turn topic into paper"
