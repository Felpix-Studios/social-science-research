---
name: write-paper
description: "Draft a full academic paper from analysis outputs, project spec, and lit review. Use when turning completed analysis into a written paper, not running analysis or reviewing existing writing."
when_to_use: "write paper, draft manuscript, write up results, start the paper, turn results into paper, write introduction, draft empirics section, I have results now write the paper, help write this up, write abstract"
