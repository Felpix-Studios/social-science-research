---
name: lit-review
description: "Structured literature review via parallel Librarian agents. Searches top journals, working paper repos (NBER, SSRN, IZA); traces citation chains from key papers. Use when surveying existing research on a topic, not finding datasets or writing a paper."
when_to_use: "review literature, find related papers, what's been done on X, search for papers on, do a lit review, find papers about, what to cite, who has written about this, survey literature, find prior work"
