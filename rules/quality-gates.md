...
Generated **only at merge time**. Use `${CLAUDE_PLUGIN_ROOT}/rules/quality-report.md` for format (read via `cat "${CLAUDE_PLUGIN_ROOT}/rules/quality-report.md"`; the template ships with the plugin).
